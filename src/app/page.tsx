...
import { MapPin, ShoppingBag, Star, Users, Utensils, ChefHat, CalendarDays, ArrowRight } from 'lucide-react'
      ...
      <section className="relative overflow-hidden py-24 px-4" style={{ background: '#FBF6EC' }}>
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-12 text-sm" style={{ color: '#8A7A63' }}>
            ...
            <span className="w-1 h-1 rounded-full" style={{ background: '#D8CBB4' }} />
            <span>Free for buyers & planners</span>
          </div>
        </div>
      </section>

      {/* Three ways in — one card per audience, each with its own CTA */}
      <section className="py-20 px-4" style={{ background: '#ffffff' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: 'Start a Storefront',
                description: 'Turn your kitchen into a business — a branded storefront, weekly menu planner, order management, and Stripe payouts.',
                cta: 'Start Your Storefront',
                href: '/auth/signup?role=seller',
              },
              {
                icon: <CalendarDays className="w-7 h-7" style={{ color: '#C1622D' }} />,
                title: 'Plan Family Meals',
                description: "Not buying or selling — just want dinner sorted. Build a weekly plan for your household with an auto-generated grocery list.",
                cta: 'Plan Family Meals',
                href: '/auth/signup?role=planner',
              },
            ].map((f) => (
              <div key={f.title} className="flex flex-col text-center p-8 rounded-2xl border transition-shadow hover:shadow-md" style={{ background: '#FAF3E6', borderColor: '#E7DDCB' }}>
                ...
                <p className="mb-6 flex-1" style={{ color: '#6B625A' }}>{f.description}</p>
                <Link href={f.href} className="inline-flex items-center justify-center gap-1.5 text-sm font-semibold hover:underline" style={{ color: '#C1622D' }}>
          ...
          <div className="text-center mt-10">
            <Link href="/features" className="text-sm font-medium hover:underline" style={{ color: '#8A4A26' }}>
      ...
      <section className="py-20 px-4" style={{ background: '#FAF3E6' }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg mb-8" style={{ color: '#6B625A' }}>
            Sign up in minutes. Always free for buyers and meal planners.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <p className="text-sm mt-6" style={{ color: '#8A7A63' }}>
            Not sure which is you?{' '}
            <Link href="/features" className="font-medium hover:underline" style={{ color: '#8A4A26' }}>
              See what&apos;s in it for buyers, chefs, and planners →
            </Link>
          </p>
        </div>
      </section>
