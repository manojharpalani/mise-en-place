    ...
    <form onSubmit={handleSubmit(onSubmit as any)} className="space-y-4">
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {suggesting && (
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 text-xs text-[#e2472b]">
        ...
        <div className="flex items-start gap-3 p-3 bg-muted rounded-lg border">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-medium text-muted-foreground flex items-center gap-1">
              <Sparkles className="w-3 h-3 text-[#e2472b]" />
              Suggested thumbnail
            </p>
      ...
      <div className="flex gap-3 pt-2">
        <Button type="submit" className="bg-[#e2472b] hover:bg-[#c43a20] flex-1" disabled={loading}>
